    ...
    <div>
      ...
      <div className="h-content w-[700px] bg-gray-50 text-xl p-4 mb-4 rounded-lg">
        ...
        <h2 className="indent-8 text-left leading-loose ">
          <span className="under-line">谁都能一帆风顺啊？谁这辈子还不遇上点儿事啊？你就拿我来说吧，过去大小也算个干部。我不是跟你吹啊，十八岁毕业我就到了自行车厂。我是先入团后入党，我上过三次光荣榜，厂长特别器重我，眼瞅要提副组长。领导一直跟我谈话，说单位减员要并厂，当时我就表了态，咱工人要替国家想，我不下岗谁下岗？</span>
        </h2>
        <br />
        <h2 className="text-left">纯css</h2>
        <h2 className="indent-8 text-left leading-loose">
          <code className="whitespace-pre break-all overflow-auto">
            code {a} <br />
